		...
		$(document).ready(function(){
			...
			$.ajax({
				  ...
				  success : function(response) {
					...
					console.log(key)
					var keyVal = Object.entries(dic)
					dic2 = keyVal[0]
					console.log(dic2)
					
					/* var key2 = Object.keys(response[key])
					console.log(key2) */
										...
										+'<div class="theater-time-box">'
											+'<table class="time-list-table">'
												+'<tbody>'
													+'<tr>'
														+'<td>'
															+'<div class="td-ab"><div class="txt-center"><p class="time">dddddd</p></div></div>'
														+'</td>'
													+'</tr>'
												+'</tbody>'
											+'</table>'
